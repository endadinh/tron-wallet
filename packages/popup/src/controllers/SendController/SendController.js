...
import { VALIDATION_STATE, APP_STATE, CONTRACT_ADDRESS, ACCOUNT_TYPE, TOP_TOKEN, SEND_STAGE,BUTTON_TYPE} from '@tronlink/lib/constants';
                ...
                <div className='insetContainer send' onClick={() => this.setState({ isOpen: { account: false, token: false } }) }>
                    ...
                    <div className='greyModal'>
                        ...
                        <Button
                            ...
                            onClick={ () => this.changeStage(SEND_STAGE.CONFIRM)}
                        />
                    </div>
                </div>
             );
             case SEND_STAGE.CONFIRM:
                 return (
                     <div className='insetContainer send'>
                         <div className='pageHeader'>
                             <div className="back" onClick={ () => this.changeStage(SEND_STAGE.SEND_FORM) }></div>
                             <FormattedMessage id="SIGN.CONFIRM.TRANSACTION"/>
                         </div> 
